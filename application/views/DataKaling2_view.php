                ...
                <div class="container-fluid mt-4">
                    ...
                    <div class="card shadow mb-4"> 
                        <div class="card-header py-3 rounded-top" style="background-color:#674188 ;"> <!-- Ditambahkan bg-primary dan rounded-top -->
                            <h6 class="m-0 font-weight-bold text-center text-white" style="font-size: 1.25rem;">Kepala Lingkungan Diproses</h6> <!-- Ditambahkan text-white -->
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover text-center" id="dataTable2" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Wilayah</th>
                                            <th>Alamat</th>
                                            <?php if ($this->session->userdata('JenisAkun') != 'Kaling'): ?>
                                            <th>Aksi</th>
                                            <?php endif; ?>
                                        </tr>
                                    </thead>
                                ...
                                if (empty($hasil)) {
                                    ...
                                    foreach ($hasil as $data): 
                                     if (($data->StatusAktivasi ?? '') !== 'Diproses') continue;
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($no); ?></td>
                                            <td> <span class="badge bg-warning text-white" title="Diproses">
